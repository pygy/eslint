...
describe("ESLint", () => {
    ...
    describe("lintText()", () => {
        ...
        describe("Fix Types", () => {
            ...
            it("should not throw an error when a rule is loaded after initialization with executeOnFiles()", async () => {
                ...
                const privateMembers = getESLintPrivateMembers(eslint);

                privateMembers.linter.defineRule(
                    "no-program",
    ...
    describe("lintFiles()", () => {
        ...
        it("should throw an error when given a config file and a valid file and invalid parser", async () => {
            ...
            assert.throws(() => eslint.lintFiles(["lib/cli.js"]), "Cannot find module 'test11'");
        });
        ...
        it("should throw an error when given a directory with all eslint excluded files in the directory", async () => {
            ...
            assert.throws(() => {
                eslint.lintFiles([getFixturePath("./cli-engine/")]);
        ...
        it("should throw an error when all given files are ignored", async () => {
            ...
            assert.throws(() => {
                eslint.lintFiles(["tests/fixtures/cli-engine/"]);
        ...
        it("should throw an error when all given files are ignored via ignore-pattern", async () => {
            ...
            assert.throws(() => {
                eslint.lintFiles(["tests/fixtures/*-quoted.js"]);
        ...
        it("should throw an error when loading a bad custom rule", async () => {
            ...
            assert.throws(() => {
                eslint.lintFiles([getFixturePath("rules", "test", "test-custom-rule.js")]);
        ...
        describe("cache", () => {
            ...
            it("should not contain in the cache a file that was deleted", async () => {
                ...
                eslint.lintFiles([badFile, goodFile, toBeDeletedFile]);
                 ...
                 */
                eslint.lintFiles([badFile, goodFile]);
            ...
            it("should contain files that were not visited in the cache provided they still exist", async () => {
                ...
                eslint.lintFiles([badFile, goodFile, testFile2]);
            ...
            it("should not delete cache when executing on text with a provided filename", async () => {
                ...
                eslint.lintText("var bar = foo;", "fixtures/passing.js");
        ...
        describe("multiple processors", () => {
            ...
            it("should throw an error if invalid processor was specified.", async () => {
                ...
                try {
                    ...
                    assert.strictEqual(
                        /ESLint configuration of processor in '\.eslintrc\.json' is invalid: 'markdown\/unknown' was not found\./u.test(e.message)
                        , true
                    );
                    return;
                }
